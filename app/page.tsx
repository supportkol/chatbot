...
const SUGGESTION_POOL = [
    "party wear anarkali suits for women",
    "party wear indian suits for women",
    "party wear lehenga choli",
    "party wear ethnic outfits",
    "smart casual indian clothing",
    "smart casual salwar suits",
    "occasion wear ethnic dresses",
    "occasion wear lehenga",
    "bridal indian wedding outfits",
    "bridal lehenga for wedding",
    "bridal anarkali suits",
    "bollywood inspired ethnic wear",
    "designer anarkali suits and gowns",
    "traditional salwar suits",
    "pashmina salwar kameez",
    "latest ethnic fashion arrivals",
    "designer sarees for women",
    "ready to wear indian outfits",
    ...
    "anarkali dresses and gowns",
    "evening party dresses",
    "designer kurtis for women",
    "party wear kurtis",
    "smart casual kurtis",
    "palazzo suits for women",
    "churidar suits",
    "designer salwar kameez",
    "straight cut salwar suit",
    "cigarette pants ethnic wear",
    "jacket style ethnic wear",
    "bridesmaid dresses",
    "designer saree blouse",
    "short ethnic dresses",
    "long ethnic dresses",
    "fancy ethnic wear",
    "flared dresses",
    "kaftan dresses",
    ...
    "panelled lehenga",
    "a line lehenga",
    "winter ethnic collection",
    "black friday ethnic sale",
    "wedding collection",
    "sharara gharara suits",
    "plus size indian clothing",
    "chaniya choli",
    "patiala suits",
    "ethnic fabrics collection",
    "clutch bags",
    "designer silk lehenga",
    "velvet lehenga",
    "net lehenga choli",
    "festive lehengas",
    "ethnic styles collection",
    "circular lehenga",
    "latest georgette sarees",
    "wedding lehenga",
    "bridal lehenga",
    "silk anarkali suit",
    "net anarkali suit",
    ...
    "cocktail wear lehengas",
    "cocktail anarkali suit",
    "festive anarkali suit",
    "festive wear sarees",
    "cocktail sarees",
    "cocktail salwar kameez",
    ...
    "chinon salwar kameez",
    "velvet saree",
    "linen ethnic wear",
    "satin ethnic wear",
    "rayon salwar kameez",
    "rayon anarkali suit",
    "fast shipping ethnic wear",
    "festive ethnic collection",
    "navratri dresses",
    ...
    "kutchi saree",
    "shop by videos",
    "light and elegant outfits",
    "off the shelf fashion",
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      suggestions: getRandomSuggestions(10) // <--- Fixed text hata kar yeh likhein
    }
  ]);
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        {
          ...
          suggestions: getRandomSuggestions(10) // <--- Yahan bhi yeh function call karein
        }
      ]);
    } catch (error) {
